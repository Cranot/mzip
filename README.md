...
**Result:** 62% win rate across 250 tests (50 data types × 5 sizes) against 8 compressors including brotli, bzip2, xz, 7z, and rar.
...
| **Structured JSON/XML** | 100% | Template extraction captures repeating structure |
| **Log files** | 95% | Columnar separation + BWT on each column |
| **Audio/sensor data** | 90% | Delta encoding exploits temporal correlation |
...
| Scenario | Winner | Why |
|----------|--------|-----|
| Small files (<16KB) | brotli | 120KB static dictionary knows common code tokens |
| Random/encrypted data | zstd | No patterns to detect, just raw entropy coding |
| Terraform/K8s configs | brotli | Domain-specific keywords in brotli's dictionary |
...
|------------|-----------|-------|------|------|------|-------|------|
| **mzip v0.9** | **8.18x** | 1.0-32768x | 0.6 | **155** | **62.0%** | **127.6** | **1** |
| brotli:11 | 5.78x | 1.0-1716x | 0.3 | 51 | 20.4% | 31.4 | 2 |
| bzip2:9 | 5.66x | 1.0-1000x | 0.6 | 48 | 19.2% | 31.3 | 3 |
| rar:m5 | 5.97x | 1.0-1014x | 2.5 | 0 | 0.0% | 6.5 | 4 |
| xz:9 | 5.89x | 1.0-997x | 2.3 | 0 | 0.0% | 6.4 | 5 |
| 7z:mx9 | 5.88x | 1.0-922x | 2.3 | 0 | 0.0% | 6.4 | 6 |
| zstd:19 | 5.14x | 1.0-2641x | 1.4 | 0 | 0.0% | 5.3 | 7 |
| gzip:9 | 4.78x | 1.0-240x | 0.8 | 0 | 0.0% | 4.7 | 8 |
...
*zstd decompresses 43.6x faster than mzip*
...
### Where brotli Wins (Top 10 Weaknesses at 4KB)

At 4KB, brotli's 120KB static dictionary dominates since mzip can't exploit patterns in small samples.

| Type | mzip | Best | Gap |
|------|------|------|-----|
| HTML (4KB) | 1027B | **brotli: 821B** | +206B |
| TypeScript/JSX (4KB) | 987B | **brotli: 840B** | +147B |
| Java (4KB) | 821B | **brotli: 690B** | +131B |
| CSS (4KB) | 860B | **brotli: 733B** | +127B |
| Makefile (4KB) | 816B | **brotli: 697B** | +119B |
| Terraform HCL (4KB) | 687B | **brotli: 571B** | +116B |
| PHP (4KB) | 792B | **brotli: 678B** | +114B |
| YAML config (4KB) | 745B | **brotli: 633B** | +112B |
| Docker Compose (4KB) | 608B | **brotli: 515B** | +93B |
| Image gradient (4KB) | 36B | **brotli: 26B** | +10B |
