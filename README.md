...
**Result:** 74% win rate across 250 tests (50 data types × 5 sizes) against 8 compressors including brotli, bzip2, xz, 7z, and rar.
...
|------------|-----------|-------|------|------|------|-------|------|
| **mzip** | **8.16x** | 1.0-32768x | 0.5 | **186** | **74.4%** | **150.4** | **1** |
| bzip2:9 | 5.66x | 1.0-1000x | 0.6 | 65 | 26.0% | 40.3 | 2 |
| zstd:19 | 5.14x | 1.0-2641x | 1.3 | 30 | 12.0% | 21.1 | 3 |
| rar:m5 | 5.97x | 1.0-1014x | 2.3 | 0 | 0.0% | 6.5 | 4 |
| xz:9 | 5.89x | 1.0-997x | 2.2 | 0 | 0.0% | 6.4 | 5 |
| 7z:mx9 | 5.88x | 1.0-922x | 2.1 | 0 | 0.0% | 6.3 | 6 |
...
*zstd decompresses 49.1x faster than mzip*
